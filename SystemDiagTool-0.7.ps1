...
while ($mainMenuActive) {
    ...
    Write-Host "    [ A]  Run all sections" -ForegroundColor White
    Write-Host "    [ Q]  Quit"             -ForegroundColor White
    Write-Host ""
    Write-Host "  Enter numbers separated by commas, A for all, Q to quit." -ForegroundColor DarkGray
    Write-Host "  Examples:  1,2,3   or   10,11,12   or   A" -ForegroundColor DarkGray
    Write-Host ""
